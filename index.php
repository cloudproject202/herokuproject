...
<nav class="navbar navbar-dark navbar-expand-lg fixed-top bg-white portfolio-navbar gradient"
    ...
    <div class="container"><a class="navbar-brand logo" href="/">cloud project</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="nav navbar-nav ml-auto">
                ...
                <li class="nav-item"><a class="nav-link active" href="https://www.syhunt.com/pt/leakcheck/" target="_blank"></a></li>
            </ul>
            <ul class="nav navbar-nav">
                <li class="nav-item"><a class="nav-link active" href="/infos/"></a></li>
            </ul>
        </div>
    </div>
</nav>
...
<!--        <div class="alert alert-info" role="alert"><span><strong>Aviso de phishing</strong><br />O aviso é um falso-positivo provavelmente devido ao excesso de erros 5xx causados pela grande quantidade de acessos que o servidor não comportava, já foi solicitada a remoção do aviso.</span></div>-->
        ...
        <?php if ($_SERVER['REQUEST_METHOD'] === 'GET') : ?>
            ...
            <form method="post">
                <div class="form-group text-left"><label for="subject">user number</label><input
